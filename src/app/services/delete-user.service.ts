...
export class DeleteUserService {
  ...
  getAllUsers():Observable<User[]> {
    ...
    return this.http.get<User[]>("http://18.219.208.21:8080/users", { headers: headers });
  }
  ...
  searchUsers(username:string):Observable<User[]> {
    ...
    return this.http.get<User[]>("http://18.219.208.21:8080/users/search=" + username, { headers: headers });
  }
